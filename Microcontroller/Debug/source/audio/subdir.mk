...
CPP_SRCS += \
../source/audio/mfcc_controller.cpp \
../source/audio/quantization.cpp 

CPP_DEPS += \
./source/audio/mfcc_controller.d \
./source/audio/quantization.d 

OBJS += \
./source/audio/mfcc_controller.o \
./source/audio/quantization.o 


# Each subdirectory must supply rules for building sources it contributes
source/audio/%.o: ../source/audio/%.cpp source/audio/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-audio

clean-source-2f-audio:
	-$(RM) ./source/audio/mfcc_controller.d ./source/audio/mfcc_controller.o ./source/audio/quantization.d ./source/audio/quantization.o

.PHONY: clean-source-2f-audio
